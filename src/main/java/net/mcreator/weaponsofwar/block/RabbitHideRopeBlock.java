...
import net.mcreator.weaponsofwar.procedures.RabbitHideRopeOnBlockRightClickedProcedure;
...
public class RabbitHideRopeBlock extends WwowModElements.ModElement {
	@ObjectHolder("wwow:rabbit_hide_rope")
	public static final Block block = null;
	public RabbitHideRopeBlock(WwowModElements instance) {
		super(instance, 140);
	}
	...
	public static class CustomBlock extends Block implements IWaterLoggable {
		...
		public CustomBlock() {
			...
			setRegistryName("rabbit_hide_rope");
		}
		...
		public ActionResultType onBlockActivated(BlockState state, World world, BlockPos pos, PlayerEntity entity, Hand hand,
			...
			Direction direction = hit.getFace();
			{
				...
				RabbitHideRopeOnBlockRightClickedProcedure.executeProcedure($_dependencies);
			}
