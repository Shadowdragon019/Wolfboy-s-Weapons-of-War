...
public class RubyOreBlock extends WwowModElements.ModElement {
	@ObjectHolder("wwow:ruby_ore")
	public static final Block block = null;
	public RubyOreBlock(WwowModElements instance) {
		super(instance, 15);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("wwow:ruby_ore_match"), () -> CustomRuleTest.codec);
			...
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("wwow:ruby_ore"), configuredFeature);
		}
	}
	@SubscribeEvent
