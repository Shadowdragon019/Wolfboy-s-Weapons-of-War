...
public class StoneDaggerItem extends WwowModElements.ModElement {
	@ObjectHolder("wwow:stone_dagger")
	public static final Item block = null;
	public StoneDaggerItem(WwowModElements instance) {
		super(instance, 23);
	}
	...
	public void initElements() {
		elements.items.add(() -> new SwordItem(new IItemTier() {
			...
			public Ingredient getRepairMaterial() {
				return Ingredient.fromStacks(new ItemStack(CobbleItem.block, (int) (1)));
			}
