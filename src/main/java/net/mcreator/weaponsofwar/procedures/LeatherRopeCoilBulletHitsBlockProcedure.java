...
public class LeatherRopeCoilBulletHitsBlockProcedure {
	public static void executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("x") == null) {
			if (!dependencies.containsKey("x"))
				WwowMod.LOGGER.warn("Failed to load dependency x for procedure LeatherRopeCoilBulletHitsBlock!");
			return;
		}
		if (dependencies.get("y") == null) {
			if (!dependencies.containsKey("y"))
				WwowMod.LOGGER.warn("Failed to load dependency y for procedure LeatherRopeCoilBulletHitsBlock!");
			return;
		}
		if (dependencies.get("z") == null) {
			if (!dependencies.containsKey("z"))
				WwowMod.LOGGER.warn("Failed to load dependency z for procedure LeatherRopeCoilBulletHitsBlock!");
			return;
		}
		if (dependencies.get("world") == null) {
			if (!dependencies.containsKey("world"))
				WwowMod.LOGGER.warn("Failed to load dependency world for procedure LeatherRopeCoilBulletHitsBlock!");
			return;
		}
			...
			if (((world.isAirBlock(new BlockPos((int) (Math.floor(x)), (int) ((Math.floor(y)) - (placeRopeYOffset)), (int) (Math.floor(z)))))
				...
				if ((!(BlockTags.getCollection().getTagByID(new ResourceLocation(("forge:wwow/rope").toLowerCase(java.util.Locale.ENGLISH)))
					...
					world.setBlockState(new BlockPos((int) (Math.floor(x)), (int) ((Math.floor(y)) - (placeRopeYOffset)), (int) (Math.floor(z))),
							LeatherRopeBlock.block.getDefaultState(), 3);
				}
